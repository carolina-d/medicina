...
{
    public partial class _00205_AsignarFormularioPerfil : Presentacion.PlantillaFormulario.FormularioBase
    {
        ...
        public _00205_AsignarFormularioPerfil()
        {
            InitializeComponent();
        }

        public _00205_AsignarFormularioPerfil(IUnidadDeTrabajoSeguridad uowSeguridad,
            IPerfilFormularioServicio perfilFormularioServicio)
        {
            InitializeComponent();

            this.Name = "_00205_AsignarFormularioPerfil";
            this.TituloVentana = "Perfil - Formulario";
            this.Titulo = "Asignar Formulario a Perfil";
            this.Leyenda = "Aquí Ud. podrá asignar un Formulario a uno o más Perfiles";
            ...
            this._perfilFormularioServicio = perfilFormularioServicio;
        ...
        private void _00205_AsignarFormularioPerfil_Load(object sender, EventArgs e)
        {
        ...
        private void ActualizarDatosNoAsignados(string cadena)
        {
            ...
            var resultado = _perfilFormularioServicio.MostrarFormulariosNoAsignados(perfilId, cadena)
                .Select(x => new {
                                     Id = x.Id,
                                     Codigo = x.Codigo,
            ...
            this.dgvNoAsignados.Columns["Codigo"].Visible = true;
            this.dgvNoAsignados.Columns["Codigo"].HeaderText = "Codigo";
            this.dgvNoAsignados.Columns["Codigo"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            this.dgvNoAsignados.Columns["Codigo"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.dgvNoAsignados.Columns["Descripcion"].Visible = true;
            this.dgvNoAsignados.Columns["Descripcion"].HeaderText = "Formulario";
            this.dgvNoAsignados.Columns["Descripcion"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            this.dgvNoAsignados.Columns["Descripcion"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        }
        ...
        private void ActualizarDatosAsignados(string cadena)
        {
            ...
            var resultado = _perfilFormularioServicio.MostrarFormulariosAsignados(perfilId, cadena)
                .Select(x => new
                {
                    Id = x.Id,
                    Codigo = x.Codigo,
            ...
            this.dgvAsignados.Columns["Codigo"].Visible = true;
            this.dgvAsignados.Columns["Codigo"].HeaderText = "Codigo";
            this.dgvAsignados.Columns["Codigo"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            this.dgvAsignados.Columns["Codigo"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.dgvAsignados.Columns["Descripcion"].Visible = true;
            this.dgvAsignados.Columns["Descripcion"].HeaderText = "Formulario";
            this.dgvAsignados.Columns["Descripcion"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            this.dgvAsignados.Columns["Descripcion"].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
        }
        ...
        private void btnAsignar_Click(object sender, EventArgs e)
        {
            ...
            var listaFormularioNoAsignados = new List<int>();

            for (var i = 0; i < this.dgvNoAsignados.RowCount; i++)
            {
                if(!Convert.ToBoolean(this.dgvNoAsignados["chkNoAsignado", i].Value)) continue;

                listaFormularioNoAsignados.Add(Convert.ToInt32(this.dgvNoAsignados["Id", i].Value));
            }

            var perfilId = Convert.ToInt32(this.cmbPerfil.SelectedValue);
            
            _perfilFormularioServicio.VincularFormularioPerfil(listaFormularioNoAsignados, perfilId);
        ...
        private void btnDesvincular_Click(object sender, EventArgs e)
        {
            ...
            var listaFormularioAsignados = new List<int>();

            for (var i = 0; i < this.dgvAsignados.RowCount; i++)
            {
                if (!Convert.ToBoolean(this.dgvAsignados["chkAsignado", i].Value)) continue;

                listaFormularioAsignados.Add(Convert.ToInt32(this.dgvAsignados["Id", i].Value));
            }

            var empresaId = Convert.ToInt32(this.cmbPerfil.SelectedValue);

            _perfilFormularioServicio.DesvincularFormularioPerfil(listaFormularioAsignados, empresaId);
