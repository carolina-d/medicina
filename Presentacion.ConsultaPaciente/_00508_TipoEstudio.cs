...
{
    public partial class _00508_TipoEstudio : Presentacion.PlantillaFormulario.FormularioConsulta
    {
        private readonly IUnidadDeTrabajoConsultaPaciente _uowConsultaPaciente;
        public _00508_TipoEstudio(IUnidadDeTrabajoConsultaPaciente uowConsultaPaciente)
        {
            this.Name = "_00508_TipoEstudio";
            this.TituloVentana = "Tipo de Estudio";
            this.Titulo = "Consulta de Tipo de Estudio";
            this.Leyenda = "Aquí Ud. podrá Agregar, Eliminar o Modificar un Tipo de Estudio y Consultar sus Datos";
        ...
        public override void ActualizarDatosGrilla(string textoBuscar)
        {
            ...
            var resultado = _uowConsultaPaciente.TipoEstudioRepositorio.ObtenerPorFiltro(x => x.Descripcion.Contains(textoBuscar)
        ...
        {
            if (new _00509_ABM_TipoEstudio(PlantillaFormulario.Clases.TipoOperacion.Nuevo, null).ShowDialog() == DialogResult.Yes)
            {
        ...
        {
            if (new _00509_ABM_TipoEstudio(PlantillaFormulario.Clases.TipoOperacion.Modificar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
        ...
        {
            if (new _00509_ABM_TipoEstudio(PlantillaFormulario.Clases.TipoOperacion.Eliminar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
