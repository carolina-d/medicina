...
{
    public partial class _00506_Certificado : Presentacion.PlantillaFormulario.FormularioConsulta
    {
        private readonly IUnidadDeTrabajoConsultaPaciente _uowConsultaPaciente;
        public _00506_Certificado(IUnidadDeTrabajoConsultaPaciente uowConsultaPaciente)
        {
            InitializeComponent();

            this.Name = "_00506_Certificado";
            this.TituloVentana = "Certificado";
            this.Titulo = "Consulta de Certificado";
            this.Leyenda = "Aquí Ud. podrá Agregar, Eliminar o Modificar un Certificado y Consultar sus Datos";
        ...
        public override void ActualizarDatosGrilla(string textoBuscar)
        {
            ...
            var resultado = _uowConsultaPaciente.CertificadoRepositorio.ObtenerPorFiltro(x => x.Descripcion.Contains(textoBuscar)
        ...
        {
            if (new _00507_ABM_Certificado(PlantillaFormulario.Clases.TipoOperacion.Nuevo, null).ShowDialog() == DialogResult.Yes)
            {
        ...
        {
            if (new _00507_ABM_Certificado(PlantillaFormulario.Clases.TipoOperacion.Modificar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
        ...
        {
            if (new _00507_ABM_Certificado(PlantillaFormulario.Clases.TipoOperacion.Eliminar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
