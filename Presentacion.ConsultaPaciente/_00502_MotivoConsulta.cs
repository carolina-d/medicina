...
{
    public partial class _00502_MotivoConsulta : Presentacion.PlantillaFormulario.FormularioConsulta
    {
        private readonly IUnidadDeTrabajoConsultaPaciente _uowConsultaPaciente;
        public _00502_MotivoConsulta(IUnidadDeTrabajoConsultaPaciente uowConsultaPaciente)
        {
            InitializeComponent();
            this.Name = "_00500_MotivoConsulta";
            this.TituloVentana = "MotivoConsulta";
            this.Titulo = "Consulta de Motivo Consulta";
            this.Leyenda = "Aquí Ud. podrá Agregar, Eliminar o Modificar un MotivoConsulta y Consultar sus Datos";
