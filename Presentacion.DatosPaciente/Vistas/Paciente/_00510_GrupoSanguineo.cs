...
{
    public partial class _00510_GrupoSanguineo : Presentacion.PlantillaFormulario.FormularioConsulta
    {
        private readonly IUnidadDeTrabajoDatosPaciente _uowDatosPaciente;

        public _00510_GrupoSanguineo(IUnidadDeTrabajoDatosPaciente uowDatosPaciente)
        {
            InitializeComponent();

            this.Name = "_00510_GrupoSanguineo";
            this.TituloVentana = "Grupo Sanguineo";
            this.Titulo = "Consulta de Grupo Sanguineos";
            this.Leyenda = "Aquí Ud. podrá Agregar, Eliminar o Modificar un Grupo Sanguineo y Consultar sus Datos";
        ...
        public override void ActualizarDatosGrilla(string textoBuscar)
        {
            ...
            var resultado = _uowDatosPaciente.GrupoSanguineoRepositorio.ObtenerPorFiltro(x => x.Descripcion.Contains(textoBuscar)
        ...
        {
            if (new _00511_ABM_GrupoSanguineo(PlantillaFormulario.Clases.TipoOperacion.Nuevo, null).ShowDialog() == DialogResult.Yes)
            {
        ...
        {
            if (new _00511_ABM_GrupoSanguineo(PlantillaFormulario.Clases.TipoOperacion.Modificar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
        ...
        {
            if (new _00511_ABM_GrupoSanguineo(PlantillaFormulario.Clases.TipoOperacion.Eliminar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
