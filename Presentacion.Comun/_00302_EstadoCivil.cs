...
{
    public partial class _00302_EstadoCivil : PlantillaFormulario.FormularioConsulta
    {
        private readonly IUnidadDeTrabajoComun _uowComun;

        public _00302_EstadoCivil(IUnidadDeTrabajoComun uowComun)
        {
            InitializeComponent();

            this.Name = "_00302_EstadoCivil";
            this.TituloVentana = "Estado Civil";
            this.Titulo = "Consulta de EstadoCivil";
            this.Leyenda = "Aquí Ud. podrá Agregar, Eliminar o Modificar un Estado Civil y Consultar sus Datos";
        ...
        public override void ActualizarDatosGrilla(string textoBuscar)
        {
            ...
            var resultado = _uowComun.EstadoCivilRepositorio.ObtenerPorFiltro(x => x.Descripcion.Contains(textoBuscar)
        ...
        private void FormatearGrilla()
        {
            ...
            this.dgvBusqueda.Columns["Descripcion"].HeaderText = "Estado Civil";
        ...
        {
            if (new _00303_ABM_EstadoCivil(PlantillaFormulario.Clases.TipoOperacion.Nuevo, null).ShowDialog() == DialogResult.Yes)
            {
        ...
        {
            if (new _00303_ABM_EstadoCivil(PlantillaFormulario.Clases.TipoOperacion.Modificar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
        ...
        {
            if (new _00303_ABM_EstadoCivil(PlantillaFormulario.Clases.TipoOperacion.Eliminar, base.EntidadId).ShowDialog() == DialogResult.Yes)
            {
                ActualizarDatosGrilla(string.Empty);
            }
        }
